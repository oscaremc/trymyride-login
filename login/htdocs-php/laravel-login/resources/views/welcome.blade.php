    ...
    <head>
        ...
        <style>
            ...
            html {
                ...
                background: -webkit-linear-gradient(to right, #f5af19, #1565C0);  /* Chrome 10-25, Safari 5.1-6 */
                background: linear-gradient(to right, #f5af19, #1565C0); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                ...
                <div style="display: grid; text-align: center;">
                    @auth
                        <a href="{{ url('/home') }}" style=" border-radius: 10px; margin: 20px; padding: 0px 40px; background: limegreen;  font-size: 30px; ">Home</a>
                    @else
                        <a href="{{ route('login') }}" style=" border-radius: 10px; margin: 20px; padding: 0px 40px; background: lime; font-size: 30px; color: black; box-shadow: 6px 6px 10px #000;">Inicio de Sesión</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" style=" border-radius: 10px; margin: 20px; padding: 0px 40px; background: dodgerblue  ; color: black; font-size: 30px; box-shadow: 6px 6px 10px #000;">Registro</a>
                        @endif
                        
                        <a href="{{ route('login') }}" style="border-radius: 10px; margin: 20px; padding: 0px 40px; background: silver ; color: black; font-size: 30px; box-shadow: 6px 6px 10px #000;">Editar Perfil</a>
